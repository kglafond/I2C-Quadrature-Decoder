...
HD_PWD='C:/Repos/External test Repo/I2C QuadratureDecoder/I2C QuadratureDecoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_quad_decode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_quad_decode.tcl
