...
HD_PWD='C:/Repos/External test Repo/I2C QuadratureDecoder/I2C QuadratureDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_quad_decode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_quad_decode.tcl -notrace
