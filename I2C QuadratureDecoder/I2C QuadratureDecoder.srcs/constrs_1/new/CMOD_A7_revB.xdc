...
create_clock -period 83.330 -name sys_clk_pin -waveform {0.000 41.660} -add [get_ports sclk]
...
#set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { pio[42] }]; #IO_L9N_T1_DQS_34 Sch=pio[42]
